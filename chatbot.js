...
isInArray(wru, lastmsg)==true?(smsg="I am Jarvis and I am part of The Agrimater to help farmers", k=smsg):
...
function farmingResponse(query) {
    ...
    } else if (query.includes("WHAT DOES AGRIMATER DO")) {
        return "Agrimater is a platform that helps farmers make their farming more profitable. The idea behind Agrimater is simple: it connects farmers across India. We buy crops or fruits directly from farmers and sell them to other farmers who need them. This way, there are no middlemen involved—it's all farmer-to-farmer. This helps farmers get better prices for their products and makes farming more fair and transparent  ,  ";
